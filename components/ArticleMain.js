    ...
    <div className={styles.wrapper}>
      <div className={styles.content}>
          ...
          <div className={styles.authorContainer}>
            ...
            <div className={styles.column}>
              ...
              <div className={styles.postDetails}>
                <span> {new Date(post.data.postedOn.seconds*1000).toLocaleString('en-us',{
                month:'short',
                day:'numeric',
                
              })} • {post.data.postLength} minutes • </span><span className={styles.listenButton}>
        ...
        <div className={styles.articleMainContainer}>
          ...
          <div className={styles.articleText}>{post.data.body} vlasdan</div>
        </div>
      </div>
    </div>
  )
